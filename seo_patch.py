...
foot = f"""{FOOT_OPEN}
      <div class="fgrid">
        ...
        <!-- research.html's only other inbound link is built in JS
             (href="research.html?doc='+d.id+'"), which no crawler follows,
             so this anchor is its sole crawlable path in. -->
